...
# 检查生成的jar包
JAR_PATH="target/obkv-table-0.18.0-SNAPSHOT-jar-with-dependencies.jar"
if [ -f "$JAR_PATH" ]; then
    echo "=========================================="
    echo "编译打包成功！"
    ...
    # 复制jar包到输出目录
    OUTPUT_JAR="$OUTPUT_DIR/obkv-table-1.0-SNAPSHOT-jar-with-dependencies.jar"
